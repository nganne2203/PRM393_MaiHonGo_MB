...
class FlipFlashcard extends StatefulWidget {
  ...
  const FlipFlashcard({
    super.key, required this.kanji, required this.kana,
    required this.romaji, required this.meaning,
    required this.example, required this.exampleTr,
  });
...
class _FlipFlashcardState extends State<FlipFlashcard> with SingleTickerProviderStateMixin {
  ...
  Widget _front() => Container(
    ...
    child: Column(
      ...
      children: [
        Text('TAP TO FLIP', style: AppTextStyles.overline.copyWith(color: Colors.white70)),
        const SizedBox(height: 16),
        Text(widget.kanji, style: AppTextStyles.jp(110, color: Colors.white, w: FontWeight.w900)),
        const SizedBox(height: 12),
        Text(widget.kana, style: AppTextStyles.jp(22, color: Colors.white70, w: FontWeight.w500)),
  ...
  Widget _back() => Container(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        Text(widget.meaning, style: AppTextStyles.h1.copyWith(fontSize: 30)),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(widget.example, style: AppTextStyles.jp(16, w: FontWeight.w600)),
              const SizedBox(height: 4),
