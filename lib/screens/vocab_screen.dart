...
class _VocabScreenState extends State<VocabScreen> {
  ...
  Widget build(BuildContext context) {
    final list = kVocab.where((v) => _filter == 'All' || v.level == _filter).toList();
    return SafeArea(
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                return Container(
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      child: Text(v.kanji, style: AppTextStyles.jp(24, color: AppColors.primary)),
                    ),
                      ...
                      children: [
                        Row(children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: v.level == 'N5' ? AppColors.sakuraSoft : AppColors.skySoft,
                              borderRadius: BorderRadius.circular(4),
                            ),
                            child: Text(v.level, style: TextStyle(
                              color: v.level == 'N5' ? AppColors.sakura : AppColors.sky,
                    ...
                    IconButton(
                      icon: const Icon(Icons.volume_up_rounded, color: AppColors.primary, size: 18),
                      onPressed: () {},
                    ),
                    IconButton(
                      icon: Icon(saved ? Icons.bookmark_rounded : Icons.bookmark_border_rounded,
                          color: saved ? AppColors.sakura : AppColors.mute, size: 18),
                      onPressed: () => setState(() => saved ? _saved.remove(idx) : _saved.add(idx)),
                    ),
                  ]),
                );
              },
          ...
          PrimaryButton(label: 'Start Flashcard Session →', onTap: widget.onStart),
        ]),
      ),
    );
  }
